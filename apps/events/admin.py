...
class PublicationAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['previous_month'] = reverse('admin:events_publication_changelist') + '?start_date__gte=' + str(
            previous_month)
        extra_context['next_month'] = reverse(
            'admin:events_publication_changelist') + '?start_date__gte=' + str(next_month)
